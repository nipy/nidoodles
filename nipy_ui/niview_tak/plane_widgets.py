...
from niview_maintoolbar import MainToolbar
from niview_interactortoolbar import InteractorToolbar
...
class PlaneWidgetsWithObservers(gtk.VBox):
    ...
    def __init__(self, mainWindow, imageData=None):
        ...
        self.dlgSurf = SurfRendererProps( self.pwxyz)
        ...
        hboxUpper.pack_start(vboxObs, True, True)
    ...
    def render_observers(self, *args):
        ...
        #print "render_observers"
        self.observerX.Render()
        self.observerY.Render()
        self.observerZ.Render()
        #self.hide()
        #self.show()
        #self.observerX.queue_draw()
        #self.observerY.queue_draw()
        #self.observerZ.queue_draw()
