...
The nipy-ui branch is currently a repository for toy code for UIs and
visualization for neuroimaging with Python. We hope it will lay the
foundations for future robust code that we will distribute and rely on.

Keep in mind when developping in this branch and relying on it that it
will change and break.
